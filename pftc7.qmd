...
pftc7_fluxible_fluxes <- bind_rows(pftc7_fluxible_fluxes_co2, pftc7_fluxible_fluxes_h2o) |>
  ...
  distinct(site_id, elevation_m_asl, aspect, plot_id, day_night, flux_type, flux_category, .keep_all = TRUE)
```
...
pfct7_comparison |>
  ...
  labs(
    ...
    x = "Fluxes calculated with Fluxible (exp_zhao18 model)",
